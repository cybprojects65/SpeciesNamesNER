...
import it.cnr.asfa.textprocessing.utils.CleanFiles;
...
public class NLPHubCaller {
	...
	public void run(String language, File textFile, List<String> annotations) throws Exception {
		...
		if (status.contains("wps:ProcessFailed")) {
			...
			CleanFiles.removeTextFromJson(outputJsonFile.getAbsolutePath());
			...
			CleanFiles.removeTextFromTxt(outputAnnotationFile.getAbsolutePath());
			tempFile.delete();
